...
mutation AddProperty($user_id: ID!, $name: String!, $images: [String!]!, $night_cost: Float!, $isAvailable: Boolean!, $room: Boolean!, $house: Boolean!, $max_guests: Int!, $bed_number: Int!, $bath_number: Int!, $location: LocationInput!, $address: String!, $description: String!) {
  addProperty(user_id: $user_id, name: $name, images: $images, night_cost: $night_cost, isAvailable: $isAvailable, room: $room, house: $house, max_guests: $max_guests, bed_number: $bed_number, bath_number: $bath_number, location: $location, address: $address, description: $description) {
    _id
    user_id
    name
    images
